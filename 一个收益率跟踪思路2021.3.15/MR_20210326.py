...
if __name__=="__main__":
    ...
    # 打开excel
    wb = xlrd.open_workbook('Follw_JS_20210408.xlsx')
    # 按工作簿定位工作表
    ...
    into_file("mr_20210408",head_str)
    for a_i,num in zip(f_alist[start_index:end_index+1],range(3,end_index-start_index+3+1)):

        f_code=str_1.format(a_i,num,len_str)
        into_file("mr_20210408",f_code)

    into_file("mr_20210408", tail_str.format(f_alist[start_index],f_alist[end_index]))

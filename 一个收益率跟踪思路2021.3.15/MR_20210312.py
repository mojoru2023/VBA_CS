...
# 成本
# J1720	J1803	J3612	J4555
# 644.2  912       1527.1    5234

for i1 in alphabet:
    f_alist.append(i1)

start_index=f_alist.index("I") # 修改处1
end_index=f_alist.index("L") # 修改处2
...
if __name__=="__main__":
    ...
    into_file("mr_20210312",head_str)
    for a_i,num in zip(f_alist[start_index:end_index+1],range(3,end_index-start_index+3+1)):

        f_code=str_1.format(a_i,num,len_str)
        into_file("mr_20210312",f_code)

    into_file("mr_20210312", tail_str.format(f_alist[start_index],f_alist[end_index]))
